...
classifiers = {
    ...
    "Logistic Regression": (
        ...
        {"classifier__C": [0.01, 0.02], "classifier__penalty": ["l2"]},
    ),
    "Decision Tree": (
    ...
    "KNN": (
        ...
        {"classifier__n_neighbors": [3, 5], "classifier__weights": ["uniform"]},
    ),
    "AdaBoost": (
        AdaBoostClassifier(random_state=0),
        {"classifier__n_estimators": [10, 20], "classifier__learning_rate": [1, 2]},
    ),
    "Gradient Boosting": (
