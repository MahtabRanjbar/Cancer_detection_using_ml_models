...
from src.model_evaluation import (cross_validate_classifiers,
                                  display_cross_val_scores, display_metrics,
...
def main():
    ...
    metrics = evaluate_classifiers(
        X_train, X_test, y_train, y_test, classifiers, best_params, feature_selection
    )
    ...
    cross_val_scores = cross_validate_classifiers(
        X, y, classifiers, best_params, feature_selection
    )
